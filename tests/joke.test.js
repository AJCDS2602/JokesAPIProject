...
//Prueba Unitaria para el endpoint GET obtener chiste. Diana Rodriguez. Endpoint #1.
...
//Prueba Unitaria para el endpoint GET crear un chiste. Diana Rodriguez. Endpoint #2.
...
//Prueba Unitaria para el endpoint PUT actualizar un chiste por ID. Diana Rodriguez. Endpoint #3.
...
=======
            ...
            it('debería devolver un mensaje de error 400 si el parámetro "rating" no es un número entre 1 y 10', async () => {
                const response = await request(app)
                    .get('/api/getJokesByRating/invalidRating')
                    .expect(400);
